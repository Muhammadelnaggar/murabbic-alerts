...
function renderNutritionHeatStressAlert(){
  ...
  if (thi >= 77) {
    ...
    border = '#fecdd3';
    color = '#b91c1c';
    note = 'خطر انخفاض المأكول والطاقة الداخلة للحيوان. فعّل التبريد، وفّر مياه كافية، وقدّم العليقة في الأوقات الأبرد قبل الحكم على كفاية التركيبة.';
  } else if (thi >= 72) {
    ...
    border = '#fde68a';
    color = '#854d0e';
    note = 'راقب استهلاك العليقة والمياه خلال اليوم، خصوصًا الحيوانات عالية الإنتاج.';
  }
